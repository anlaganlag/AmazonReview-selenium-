...
class IndexSpider():
    ...
    def SaveAtDataDb(self, DataList, item):
        ...
        # EndUpdateSql = f"update TbIndexReviewSpiderTask set taskState='已完成',SpiderTime='{item['taskEndTime']}' where CASIN='{item['Asin']} and taskSite={item['Site']}"
...
if __name__ == '__main__':
    ...
    for taskid,Site,Asin,StartScrping,state in rows[2:10]:

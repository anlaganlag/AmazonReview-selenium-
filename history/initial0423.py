...
class IndexSpider():
    ...
    def Scheduling_task(self, item, url):
        ...
        try:
            ...
            # print("传入的字典:",item,"传入的全部文本:",r.text)
...
if __name__ == '__main__':
    ...
    connect.close()  # 关闭数据库
    # print(rows[61430:61431])
    ListTaskUrl = []  # 存放数据库任务

    for taskid,Site,Asin,StartScrping,state in rows[61430:61431]:
        # print(taskid,Site,Asin,StartScrping,state,"=======================")
        itemTask = {}

...
def TestFunc(countryCode,asin):
    pd_id           = "125018"     #用户中心页可以查询到pd信息
    pd_key          = "whLE9GgKO2TarM2IuSG1RRwTzGQhnG2J"
    app_id          = "325018"     #开发者分成用的账号，在开发者中心可以查询到
    app_key         = "5m9wb3DDwONl2xDB77OqIPvFC9RvHXfn"
    #识别类型，
    ...
    # 通过文件形式识别：
    file_name       = f"{countryCode+asin}img.jpg"
